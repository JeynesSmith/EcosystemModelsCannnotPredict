...
save(['FitResults/Results_ThirdOrder_Lasso' num2str(i) '_Cuttoff' num2str(j)],'FittingResults','Target','TargetExperiments','LassoParameter','CutOffParameter', '-v7.3') % save parameters and initial storage
