...
Target = 50; % number of simulations for each experiment
FittingResults = cell(111,Target,7); % initialise storage
save 'Experimental fitting results'/Results.mat FittingResults Target % save parameters and initial storage
...
load 'Experimental data'/Analysis_Timeseries.mat Analysis_Timeseries
load 'Experimental fitting results'/Results.mat FittingResults Target
...
save 'Experimental fitting results'/Results.mat FittingResults Target
end
