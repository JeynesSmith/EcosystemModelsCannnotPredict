% This script generates supplementary fits to microcosm data using AIC and 
% a cutoff. This script only fits to unique combinations of
...
save(['Experimental fitting results/Results_BAIC_Cuttoff' num2str(i) '_AllR'],'FittingResults','Target','TargetExperiments','CutOffParameter', '-v7.3') % save parameters and initial storage
